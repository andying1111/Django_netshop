...
from goodsapp.models import Category, Goods,GoodDetail
...
class DetailView(View):
    ...
    def get(self,request,goodsid,recommend_list=[]):
        ...
        # goods.GoodDetail_set.all()
        gd = goods.gooddetail_set.all()
        for i in gd:
            gdurl = i.gdurl



        return render(request,'detail.html',{'goods':goods,'recommend_list':recommend_list,'gdurl':gdurl})
